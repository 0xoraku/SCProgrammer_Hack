...
*/
//AliceがHoneypot,Bank contractをdeploy
//Bankのwithdraw関数にreentrancyの隙を作る。
//EveがAttack contractをdeployし、
//Bankのアドレスを指定して、Attackのattack関数を実行する。
//log関数が呼ばれ、Honeypotのlog関数が呼ばれ,revertする。
