...
contract KingOfEther {
    ...
    function claimThrone() external payable {
        ...
        //kingがfallbackの無いcontractの場合、
        //誰かが次のkingになろうと送金しても常にここでrevertされる。
...
contract ProtectedKingOfEtherAttack {
    ProtectedKingOfEther protectedKingOfEther;

    constructor(ProtectedKingOfEther _protectedKingOfEther) {
        protectedKingOfEther = ProtectedKingOfEther(_protectedKingOfEther);
    }

    function attack() public payable {
        protectedKingOfEther.claimThrone{value: msg.value}();
    }
}